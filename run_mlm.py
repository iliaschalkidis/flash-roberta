...
def main():
    ...
    if 'flash-roberta' in model_args.model_class and model_args.model_name_or_path:
        model = FlashRobertaForMaskedLM.from_pretrained(
    ...
    if training_args.do_train:
        ...
        if data_args.max_train_samples is not None:
            ...
            train_dataset = train_dataset.take(range(max_train_samples))
